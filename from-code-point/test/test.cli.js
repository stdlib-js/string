...
tape( 'the command-line interface creates a string from code point arguments', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'97\'; process.argv[ 3 ] = \'98\'; process.argv[ 4 ] = \'99\'; require( \''+fpath+'\' );"'
	];
...
tape( 'the command-line interface ignores trailing delimiters when used as a standard stream', opts, function test( t ) {
	var cmd = [
		'printf \'97\n98\n99\n\'',
		'|',
		EXEC_PATH,
