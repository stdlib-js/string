...
tape( 'the command-line interface prints a string right-padded with spaces', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface prints a string right-padded with a custom pad string', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
