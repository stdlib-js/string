...
* @throws {TypeError} third argument must be a string primitive or an array of string primitives
* @returns {string} trimmed string
*
* @example
* var str = '   abc   ';
* var out = rightTrimN( str, 2 );
* // returns '   abc '
*
* @example
* var str = '   abc   ';
...
* // returns ''
*/
function rightTrimN( str, n, chars ) {
	var nElems;
	var reStr;
	var isStr;
	var RE;
	...
	if ( arguments.length > 2 ) {
		...
		if ( !isStr && !isStringArray( chars ) ) {
			throw new TypeError( 'invalid argument. Must provide a string or an array of strings. Value: `' + chars + '`.' );
		}
		if ( isStr ) {
