...
tape( 'the command-line interface removes the first character of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface removes the first `n` characters of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
