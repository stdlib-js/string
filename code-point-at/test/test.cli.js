...
tape( 'the command-line interface returns the code point at a specified string position', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface supports backward iteration for low surrogates when invoked with the `--backward` flag', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface supports backward iteration for low surrogates when invoked with the `-b` flag', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'--pos=1\'; process.argv[ 3 ] = \'--backward\'; process.argv[ 4 ] = \'🌷\'; require( \''+fpath+'\' );"'
