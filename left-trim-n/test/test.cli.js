...
tape( 'the command-line interface trims whitespace from the beginning of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'   beep boop\';  process.argv[ 3 ] = \'--n=2\'; require( \''+fpath+'\' );"'
	];
