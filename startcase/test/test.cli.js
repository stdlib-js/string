...
tape( 'the command-line interface converts a string argument to startcase', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'beep boop foo bar\'; require( \''+fpath+'\' );"'
	];
