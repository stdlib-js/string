...
tape( 'the command-line interface removes the last character of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface removes the last `n` characters of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface supports specifying the type of characters to remove', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
...
tape( 'the command-line interface supports use as a standard stream (remove `n` characters)', opts, function test( t ) {
	var cmd = [
		'printf "beep\nboop"',
		'|',
		EXEC_PATH,
...
tape( 'the command-line interface supports specifying the type of characters to remove when used as a standard stream', opts, function test( t ) {
	var cmd = [
		'printf \'foo\nbar\nbaz\'',
		'|',
		EXEC_PATH,
