...
```javascript
import string from 'https://cdn.jsdelivr.net/gh/stdlib-js/string@v0.1.1-esm/index.mjs';
```
...
[test-image]: https://github.com/stdlib-js/string/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/string/actions/workflows/test.yml?query=branch:v0.1.1
