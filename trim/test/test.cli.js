...
tape( 'the command-line interface trims whitespace from the beginning and end of a string argument', opts, function test( t ) {
	var cmd = [
		EXEC_PATH,
		'-e',
		'"process.stdin.isTTY = true; process.argv[ 2 ] = \'   beep boop   \'; require( \''+fpath+'\' );"'
	];
